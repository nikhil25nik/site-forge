...
Return ONLY the enhanced prompt, nothing else. Make it detailed but concise (2-3 paragraphs max).`
        ...
        await prisma.conversation.create({
            data:{
                role:"assistant",
                content:`I have emhanced prompt to: "${enhancedPrompt}"`,
                projectId:project.id
            }
        })
    ...
    The HTML should be complete and ready to render as-is with Tailwind CSS.`
       ...
       await prisma.conversation.create({
            data:{
                role:"assistant",
                content:"I have created your website! You can now preview it and requset any changes.",
                projectId:project.id
            }
        })
...
// function for a get a project for single user
...
// function for all users project

export const getUsersProjects = async(req:Request,res:Response)=>{
    try{
        const userId = req.userId;
...
// function to toggle project publish
...
export const togglePublish = async(req:Request,res:Response)=>{
    try{
        ...
        res.json({message:project?.isPublished ? "Project Unpublished":" project Unpublished Successfully"});
...
export const purshaseCredits = async(req:Request,res:Response)=>{
    try{
        interface Plan {
            credits:number,
            amount:number
                       ...
                       cancel_url:`${origin}`,
                        line_items: [
                        {
                         price_data:{
                            currency:'usd',
                            product_data:{
                                name:`SiteForge - ${plan.credits} credits`,
                            },
