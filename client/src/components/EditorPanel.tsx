...
export default function EditorPanel({selectedElement,onUpdate,onClose}:EditorPanelProps){
            ...
            <div className="space-y-4 text-black">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        className="w-full text-ms p-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-indigo-500 outline-none"/>
                    </div>
                     <div>
