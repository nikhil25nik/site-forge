...
export default function MyPorjects(){
    ...
    return(
        <>
        <div className="min-h-screen px-4 md:px-16 containering lg:px-24 xl:px-32">
            {loading ? (
                ...
                <div className="py-10 min-h-[80vh]">
                    <div className="flex items-center justify-between mb-12">
                        ...
                        <button onClick={()=>navigate("/")} className="flex items-center text-white gap-2 px-3 sm:px-6 py-2 sm:py-2 bg-indigo-700 rounded hover:opacity-90 active:scale-95 transition-all"><PlusCircleIcon size={18}/>Create New</button>
                    </div>
                    <div className="flex flex-wrap gap-3.5">
                        {projects.map((project)=>(
                            <div key={project.id} className="relative group w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-600 rounded-lg overflow-hidden shadow-md group hover:shadow-indigo-700/30 hover:border-indigo-800/80 transition-all duration-300">
                            ...
                            <div className="p-4 text-white bg-linear-180 from-transparent group-hover:form-indigo-950 to-transparent transition-colors">
                                <div className="flex items-start justify-between">
                                    ...
                                    <button className="px-2.5 py-0.5 mt-1 ml-2 text-xs text-gray-800 border border-gray-700 rounded-ful">Website</button>
                                </div>
            ...
            (
                ...
                <h1 className="text-3xl font-semibold text-orange-500">You Have No Projects Yet!</h1>
